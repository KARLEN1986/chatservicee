...
public class MainController {
    ...
    public String getUsers(ModelMap modelMap) {
        List<AdminEntity> userList = userRepository.findAll();
    ...
    public String addUserPost(@ModelAttribute("user") AdminEntity userEntity, @RequestParam("image") MultipartFile image) throws IOException {
        //upload file
...
//        userEntity.setProfilePic(profilePic);
    ...
    public String showUser(@PathVariable("id") Long userId, ModelMap modelMap) {
        ...
        AdminEntity userEntity = userRepository.findOne(userId);
